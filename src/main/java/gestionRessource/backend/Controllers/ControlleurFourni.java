...
import gestionRessource.backend.DTO.Fournisseur.FournisseurCnx;
import gestionRessource.backend.DTO.Fournisseur.ImprimenteDto;
import gestionRessource.backend.DTO.Fournisseur.OrdinateurDto;
import gestionRessource.backend.Models.AppelOffre;
import gestionRessource.backend.Models.Fournisseur;
import gestionRessource.backend.Models.Proposition;
