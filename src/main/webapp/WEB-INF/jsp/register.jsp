                        ...
                        <form class="user" action="<c:url value='/register'/>" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" name="departementId" class="form-control form-control-user" id="exampleDepartement"
                                       placeholder="Departement ID" required> <!-- Assume it's a simple text input; ideally, this should be a dropdown -->
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <hr>
                            <!-- Social registration options can be implemented based on your backend capability -->
                        </form>
                        <hr>
                        <div class="text-center">
